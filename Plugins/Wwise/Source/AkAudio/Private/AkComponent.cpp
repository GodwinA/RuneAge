...
void UAkComponent::GetRTPCValue(FString RTPC, ERTPCValueType InputValueType, float& Value, ERTPCValueType& OutputValueType, int32 PlayingID)
{
	if (FAkAudioDevice::Get())
	{
...
{
	GetRTPCValue(RTPC, InputValueType, Value, OutputValueType, PlayingID);
}
