...
namespace WwiseEventTriggering
{
	...
	{
		UE_LOG(LogAkAudio, Warning, TEXT("Playback occurred from sequencer section with new changes. You may need to save your dirty work units and re-generate your sound data."));
	}
