...
void FWwiseEventDragDropOp::RecurseCreateAssets(TSharedPtr<FWwiseTreeItem>& Asset, const FString& PackagePath)
{
	...
	else if (Asset->IsOfType({ EWwiseTreeItemType::Bus, EWwiseTreeItemType::StandaloneWorkUnit, EWwiseTreeItemType::NestedWorkUnit, EWwiseTreeItemType::Folder, EWwiseTreeItemType::PhysicalFolder }))
	{
		for (TSharedPtr<FWwiseTreeItem> Child : Asset->Children)
		{
